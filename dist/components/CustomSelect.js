...
function CustomSelect(props) {
  var _useState = (0, React.useState)(false),
      ...
      toggleIsActive = _useState2[1];

  var optionList = props.options.map(function (option, index) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: isActive ? "custom-select isActive js-selectCustom" : "custom-select js-selectCustom",
    "aria-hidden": isActive ? "true" : "false"
  }, /*#__PURE__*/React.createElement("div", {
    className: "custom-select-trigger",
    tabIndex: "1",
    onClick: function onClick() {
      return isActive ? toggleIsActive(false) : toggleIsActive(true);
    },
    onBlur: function onBlur(e) {
      isActive && toggleIsActive(false);
    }
  }, props.options[props.selectedOptionIndex].label), /*#__PURE__*/React.createElement("div", {
